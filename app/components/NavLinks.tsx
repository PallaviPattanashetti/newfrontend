    ...
    <div className="bg-[#28a8af]/40 w-full">
      <Navbar fluid rounded={false} className="bg-transparent px-6 py-4">
        ...
        <div className="flex flex-1 md:flex-none items-center justify-center md:justify-end gap-2 md:gap-4 md:order-2 md:ml-auto">
          ...
          <input
            type="text"
            className="h-10 md:h-12 w-[160px] sm:w-[200px] md:w-[180px] lg:w-[220px] rounded-[45px] bg-[#5F4F4F]/30 placeholder:text-black text-white px-4 border-none focus:ring-0 focus:outline-none transition-all"
            placeholder="Search..."
          />
            ...
            {navItems.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  <span className="text-xs md:text-sm mt-1 font-bold text-black whitespace-nowrap">{item.label}</span>
                </motion.div>
              </NavbarLink>
            ))}
          </motion.div>

  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="w-full max-w-225 min-h-152 border border-gray-200 bg-[#28a8af]/40 backdrop-blur-md flex flex-col md:flex-row shadow-xl rounded-2xl overflow-hidden"
      >
        <DmInboxList

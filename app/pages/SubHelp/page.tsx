...
const Page = () => {
  return (
    ...
    >
      ...
      <div className="w-full max-w-[596px] min-h-[96px] bg-[#5F4F4F]/25 rounded-2xl flex items-center justify-center my-8 p-4 shadow-lg backdrop-blur-sm">
        <h1 className="text-4xl md:text-[64px] font-extrabold text-black tracking-tight text-center">
          Home Help Post
        </h1>
      </div>

      <div className="w-full max-w-[596px] flex flex-col">
        <h2 className="text-xl font-bold mb-2">Title</h2>

        <input 
          type="text"
          placeholder="Enter title here"
          className="w-full min-h-[64px] bg-[#5F4F4F]/25 rounded-2xl px-6 mb-8 border-2 border-white/20 shadow-lg backdrop-blur-sm text-black placeholder-gray-600 outline-none focus:border-black transition-all"
        />
        ...
        <textarea 
          ...
          className="w-full min-h-[200px] bg-[#5F4F4F]/25 rounded-2xl p-6 mb-8 border-2 border-white/20 shadow-lg backdrop-blur-sm text-black placeholder-gray-600 outline-none focus:border-black transition-all resize-none"
        />

        <div className="flex justify-center">
          <button className="w-full max-w-[180px] py-3 border-2 border-black bg-[#6F7887]/80 rounded-xl text-black font-bold text-[18px] sm:text-[20px] hover:bg-[#6F7887] transition-colors">
            Submit
          </button>
        </div>
      </div>
